...
// Sidebar component receives props: selectedUser & setSelectedUser
const Sidebar = () => {
  ...
  return (
    ...
    <div className={`bg-[#8188582]/10 h-full p-5 rounded-r-x1 overflow-y-scroll text-white ${selectedUser ? "max-md:hidden" : ''}`}>
